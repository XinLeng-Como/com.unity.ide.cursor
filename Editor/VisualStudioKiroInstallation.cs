...
te void CreateSettingsFile(string vscodeDirectory, bool enablePatch) {
...
rivate void PatchSettingsFile(string settingsFile) {
			try {
...
rivate static void PatchRecommendedExtensionsFile(string extensionFile) {
			try {
